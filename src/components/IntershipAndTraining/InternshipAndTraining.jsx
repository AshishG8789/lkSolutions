...
import InternComp from "./InternComp";
        ...
        <Box sx={{ minHeight: "100vh", pt: 15 }}>
            ...
            >
                ...
                <Typography variant="h6" sx={{ color: "#5a5a5a", mb: 4, pb: 3 }}>
                    ...
                    Kick-Start Your Career with LK Solutions Pvt. Ltd. Are you ready to embark on an exciting journey
                    that will shape your future and unlock your potential? If you're seeking a dynamic environment where
                    you can gain hands-on experience and grow in your field of interest, look no further. LK Solutions
                    Pvt. Ltd. is offering exclusive internship opportunities designed to help you build a solid
                    foundation for your career and become a future leader in your industry. At LK Solutions, we believe
                    in empowering talented individuals like you by providing the resources, mentorship, and real-world
                    challenges you need to thrive. Our internships are not just about learning the basics; they are
                    designed to provide immersive, project-based experiences that allow you to apply your knowledge,
                    develop new skills, and contribute to innovative solutions.
                </Typography>
