    ...
    return (
        <Container maxWidth="lg">
            <Box display="flex" justifyContent="space-between" mb={4}>
                <Typography variant="h3" fontWeight="bold" color="text.primary" textAlign="" sx={{ flexGrow: 1 }}>
                    Our Services
                </Typography>
                <Button
                    variant="contained"
                ...
                {serviceData.map((service, index) => (
                    <Grid item xs={12} sm={6} md={4} key={index}>
                        ...
                        >
                            ...
                            />
                            <Typography variant="h6" fontWeight="bold" textAlign="center" color="text.primary">
                                {service.title}
                            </Typography>
