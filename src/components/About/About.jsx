...
const About = () => {
    ...
    useEffect(() => {
        incrementCounter(400, setClients);
        incrementCounter(110, setProjects);
    }, []);
                    ...
                    <Grid item xs={12} md={6}>
                        ...
                        >
                            <YearsInfo>
                                ...
                                <Typography
                                    variant="h5"
                                    sx={{ letterSpacing: "0.625rem", fontWeight: 600, color: "#12141d" }}
                                >
                                    Years
                                </Typography>
                            </YearsInfo>
                        ...
                        <Box>
                            <Typography
                                sx={{ color: "#5a5a5a", mb: 4, fontSize: 20, textAlign: { xs: "center", md: "left" } }}
                            >
                        ...
                        <Box>
                            ...
                            >
                                <Typography
                                    variant="h5"
                                    sx={{
                                        borderRight: { md: "2px solid #dee2e6" },
                                        pr: { md: 3 },
                                        mr: { md: 3 },
                                        fontWeight: 600,
                                        color: "#12141d",
                                ...
                                <Box sx={{ display: "flex", alignItems: "center" }}>
                                    ...
                                    <Typography variant="h2" sx={{ fontSize: { xs: "1.75rem", md: "2rem" }, ml: 1 }}>
                                        +
                                    </Typography>
                                </Box>
                            </Box>
                            <Typography sx={{ color: "#5A5A5A", mb: 4, textAlign: { xs: "center", md: "left" } }}>
                                With our vast experience of dealing with clients in various domains and industries, we
                                are confident to deliver the best possible development services to businesses.
                            </Typography>
                            <Box
                                sx={{
                                    display: "flex",
