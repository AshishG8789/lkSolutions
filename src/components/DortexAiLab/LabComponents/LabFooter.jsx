                ...
                <Grid item xs={12} md={4}>
                    ...
                    <div style={{ paddingTop: "1.5rem" }}>
                        {[
                            ...
                            "https://www.linkedin.com/company/dortex-ai/",
                            "https://www.instagram.com/dortex_ai/?hl=en",
                        ].map((url, index) => (
                            <IconButton
                                component={Link}
                                href={url}
                            ...
                            >
                                <i
                                    className={`fab fa-${url.split("/")[2].split(".")[1]}`}
                                    style={{ color: "white" }}
                                ></i>
                            </IconButton>
                        ))}
                ...
                <Grid item xs={12} md={4}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", marginTop: "1rem" }}>
                        ...
                        <Typography variant="body2">
                            AI Research Lab, Chandigarh Group of College, Landran Mohali Punjab
                        </Typography>
                    </div>
